...
create table section(section_id varchar(255), semester varchar(255), year varchar(255), course_id varchar(255), foreign key(course_id) references course(course_id), building varchar(255), room_number varchar(255), foreign key(building, room_number) references classroom(building,room_number), time_slot_id varchar(255), foreign key(time_slot_id) references time_slot(time_slot_id), primary key(course_id, section_id, semester, year));
